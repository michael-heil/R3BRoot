 ...
 //if(data->LOS[d].VTF == 8 && data->LOS[d].TTFL == 8 && data->LOS[d].VTF == 8){
		...
		for (int i=0;i<numChannels;i++)
		{
			...
			for (int j = curChannelStart; j < nextChannelStart; j++){
			    ...
			    // if(fNEvents == 17077 || fNEvents == 17415 || fNEvents == 17416) 
			    // cout<<"Reader VFTX "<<fNEvents<<", "<<channel<<", "<<data->LOS[d].VTFv[j]<<", "<<data->LOS[d].VTCv[j] <<endl;
			}
		...
		for (int i=0;i<numChannels;i++)
		{
			...
			for (int j = curChannelStart; j < nextChannelStart; j++){
			   ...
			   // if(fNEvents == 17077 || fNEvents == 17415 || fNEvents == 17416) 
			   // cout<<"Reader Leading "<<fNEvents<<", "<<channel<<", "<<data->LOS[d].TTFLv[j]<<", "<<data->LOS[d].TTCLv[j] <<endl;
			}
		...
		for (int i=0;i<numChannels;i++)
		{
			...
			for (int j = curChannelStart; j < nextChannelStart; j++){
			   ...
			   //if(fNEvents == 17077 || fNEvents == 17415 || fNEvents == 17416) 
			   //cout<<"Reader Trailing "<<fNEvents<<", "<<channel<<", "<<	data->LOS[d].TTFTv[j]<<", "<<data->LOS[d].TTCTv[j] <<endl;
